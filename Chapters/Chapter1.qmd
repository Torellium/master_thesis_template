...
# Results {#sec-Chapter1}

## Synthesis

Detta är en resultatdel där vis ka ha en figur.

![**CuAAC syntesväg.** schematisk figur som visar hur 3'ändan av en oligonukleotid märks in med en fluorophore. **a)** Panel a visar detta. **b)** Panel B visar detta.](../Figures/cuaac_fluorophore.pdf){#fig-cuaac width=16cm}

Som ni kan se i **@fig-cuaac** så verkar detta fungera.
...
![*hej hej*](../Figures/bacteria_detection.pdf){#fig-bacteria width=16cm}
